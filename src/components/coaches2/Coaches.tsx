            ...
            <div className="coaches-list">
                <div className="coaches-left">
                    ...
                    <div className="coaches-left__item">
                        ...
                        <div className="coaches-left__dropdown">
                            Fitness & Gym
                            {dropDown}
                    ...
                    <div className="coaches-left__item">
                        ...
                        <div className="coaches-left__search">
                        ...
                        <div className="coaches-left__flex-gap-10">
                            <div className="coaches-left__button black">
                                Xem
                            </div>
                            <div className="coaches-left__button">
                                Xem
                            </div>
                            <div className="coaches-left__button">
                                Xem
                    ...
                    <div className="coaches-left__item">
                        ...
                        <div className="coaches-left__slide">
                        ...
                        <div className="coaches-left__price">
                            ...
                            <div className="right">100.000.000₫</div>
                        </div>
                    </div>
                    <div className="coaches-left__item">
                        <div className="title">
                    ...
                    <div className="coaches-left__item">
                        ...
                        <div className="coaches-left__radio">
                            <input type="radio" name="type" /><span>Tất cả</span>
                ...
                <div className="coaches-right">
                    <div className="coaches-right__header">
                        <div className="title">Danh sách huấn luyện viên</div>
                        <div className="item">
                            <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className="coaches-right__card">
                        <img src="/images/Testimonial.png" alt="" className="coaches-right__card--image" />
                        <div className="coaches-right__card--container">
                            <div className="content">
                                <div className="top">
                                    <div className="title">Tên huấn luyện viên <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div className="rating">
                                    <div className="item">
                                        ...
                                        <span>4.98</span>
                                        <span className="normal">(182)</span>
                                    </div>
                                    <div className="item">
                            ...
                            <div className="price">
                                <div className="left">
                                    ...
                                    <div className="bottom "><span className="bottom green">2.500.000</span>₫ /giờ</div>
                                </div>
                                <div className="right">
